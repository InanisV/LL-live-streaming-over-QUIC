#define NGX_CONFIGURE " --prefix=/root/nginx-1.16.1 --build=quiche-1780aece --with-http_ssl_module --with-http_v2_module --with-http_v3_module --with-openssl=../quiche/quiche/deps/boringssl --with-quiche=../quiche"
...
#ifndef NGX_HAVE_SO_TXTIME
#define NGX_HAVE_SO_TXTIME  1
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/root/nginx-1.16.1/"
#endif
...
#ifndef NGX_BUILD
#define NGX_BUILD  "quiche-1780aece"
#endif
